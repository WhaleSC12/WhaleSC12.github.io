...
form.addEventListener('submit', function(e) {
    ...
    const object = Object.fromEntries(formData); // Convert to an object
    const json = JSON.stringify(object); // Convert to JSON format
    ...
    .catch(error => {
        ...
        result.innerHTML = "There was an error sending your message.";
        result.style.color = "red";
    })
    .finally(() => {
        form.reset(); // Clear the form
        setTimeout(() => {
            result.innerHTML = ""; // Clear the result message after a few seconds
        }, 3000);
    });
});
